...
export default function ManageUsersPage() {
  ...
  const allUsers = [
    { id: 1, name: "Sanjani", email: "sanjanimapa@gmail.com", role: "Teacher", status: "Active" },
    { id: 2, name: "sanjani", email: "sanjanimapa@gmail.com", role: "Student", status: "Active" },
    { id: 3, name: "Sanjani", email: "sanjanimapa@gmail.com", role: "Parent", status: "Active" },
    { id: 4, name: "Sanjani", email: "sanjanimapa@gmail.com", role: "Teacher", status: "Inactive" },
    { id: 5, name: "Sanjani", email: "sanjanimapa@gmail.com", role: "Student", status: "Active" },
    { id: 6, name: "Sanjani", email: "sanjanimapa@gmail.com", role: "Parent", status: "Active" },
    { id: 7, name: "Sanjani", email: "sanjanimapa@gmail.com", role: "Student", status: "Inactive" },
    { id: 8, name: "Sanjani", email: "sanjanimapa@gmail.com", role: "Teacher", status: "Active" },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <tr key={user.id} className="hover:bg-gray-50/50 transition">
                  ...
                  <td className="px-8 py-5">
                    <div className="flex justify-center">
                      <span className={`px-4 py-1 rounded-full text-[10px] font-bold uppercase ${getRoleStyle(user.role)}`}>
                        {user.role}
                      </span>
                    </div>
                  </td>
                  <td className="px-8 py-5">
                    <div className="flex justify-center">
                      <span className={`px-4 py-1 rounded-full text-[10px] font-bold uppercase ${getStatusStyle(user.status)}`}>
                        {user.status}
                      </span>
                    </div>
                  </td>
        ...
        <div className="p-6 border-t border-gray-50 flex justify-between items-center text-sm text-gray-400 font-medium">
          <span>Showing {paginatedUsers.length > 0 ? (currentPage - 1) * itemsPerPage + 1 : 0} to {Math.min(currentPage * itemsPerPage, filteredUsers.length)} of {filteredUsers.length} results</span>
