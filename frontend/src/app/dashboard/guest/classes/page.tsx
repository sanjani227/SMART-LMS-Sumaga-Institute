...
import { Search, Plus, Pencil, Trash2, ChevronLeft, ChevronRight, BookOpen, CheckCircle, Users } from 'lucide-react';

export default function ManageClassesPage() {
  const classes = [
    { name: "Mathematics", grade: "Grade 8", teacher: "Nilantha", students: 32, schedule: "Monday, Wednesday, Friday - 9:00 AM", status: "Active" },
    { name: "Sinhala", grade: "Grade 9", teacher: "Nimal", students: 28, schedule: "Tuesday, Thursday - 11:00 AM", status: "Active" },
    { name: "World History", grade: "Grade 10", teacher: "Kamal", students: 25, schedule: "Monday, Wednesday - 1:00 PM", status: "Active" },
    { name: "English Literature", grade: "Grade 8", teacher: "Ashoka", students: 30, schedule: "Tuesday, Thursday - 9:00 AM", status: "Active" },
    { name: "Physics", grade: "Grade 12", teacher: "Sumudu", students: 22, schedule: "Monday, Wednesday, Friday - 11:00 AM", status: "Inactive" },
    { name: "Science", grade: "Grade 7", teacher: "Sugath", students: 35, schedule: "Monday, Wednesday, Friday - 10:00 AM", status: "Active" },
  ];

  const stats = [
    { label: "Total Classes", value: "6", icon: <BookOpen size={24} />, color: "text-orange-500", bg: "bg-orange-50" },
    { label: "Active Classes", value: "5", icon: <CheckCircle size={24} />, color: "text-green-500", bg: "bg-green-50" },
    { label: "Total Students", value: "172", icon: <Users size={24} />, color: "text-blue-500", bg: "bg-blue-50" },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <select className="bg-gray-50 border-none rounded-lg px-4 py-2 text-sm text-gray-600 outline-none focus:ring-2 focus:ring-orange-200">
          ...
          {[7, 8, 9, 10, 11, 12, 13].map(g => <option key={g}>Grade {g}</option>)}
        </select>
      </div>
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <button className="px-4 py-2 bg-orange-600 text-white rounded-lg font-semibold">1</button>
            <button className="p-2 hover:bg-gray-100 rounded-lg transition text-gray-600">
